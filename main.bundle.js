...
class PlayerController {
    constructor(scene, b2Physics) {
        ...
        _index__WEBPACK_IMPORTED_MODULE_1__.DEBUG && new _util_DebugMouseJoint__WEBPACK_IMPORTED_MODULE_4__.DebugMouseJoint(scene, b2Physics);
    }
    update(delta) {
        var _a;
...
const DEFAULT_ZOOM = Number(localStorage.getItem('snowboarding_game_zoom') || 1);
const RESOLUTION_SCALE = Number(localStorage.getItem('snowboarding_game_resolution') || 1);
const DEBUG = Boolean(localStorage.getItem('snowboarding_game_debug'));
const gameConfig = {
