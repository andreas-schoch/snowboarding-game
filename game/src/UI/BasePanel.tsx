...
export const BasePanel: ParentComponent<{id: string, title: string, scroll: boolean, backBtn: boolean, setPanel: (id: PanelId) => void}> = props => (
  <div id={props.id} class={'bg-neutral-800 border-neutral-500 w-[700px] absolute -translate-x-1/2 -translate-y-1/2 text-[8px] text-[color:var(--panel-text-color)] max-w-[100vw] max-h-screen m-0 pt-12 pb-4 px-4 rounded-md border-[3px] border-solid left-2/4 top-2/4'}>
